...
{$ENDIF}
  ...
  private
    ...
    FBarcod:String;
    FOnBarcod:TBarcodEvent;
    FCountBarCod:integer;
    ...
    procedure SetComPort(const Value: TCustomComPort);
    procedure SetBarcod(const Value: string);
...
{$ENDIF}
  ...
  public
    ...
    property Barcod :STring read  FBarcod Write SetBarcod;
    ...
    property OnBarcod: TBarcodEvent read FOnBarcod write FOnBarcod;
...
procedure TCustomComTerminal.KeyPress2( Key: Char);
begin
  inherited KeyPress(Key);
  SendChar(Key);
end;
...
begin
  case Ch of
    ...
    #13:begin
          if Assigned(FOnBarcod) then
           FOnBarcod(Self,Barcod , FCountBarCod);
           FCountBarCod:=0;
           SetBarcod('');
    ...
    #32..#255:
      begin
        ...
        begin
          FBarcod:=FBarcod+string(Ch);
          FCountBarCod:=FCountBarCod+1;
          TermCh := GetCharAttr;
          TermCh.Ch := Ch;
...
procedure TCustomComTerminal.SetBarcod(const Value: string);
begin
  if Value <> FBarcod then
  begin
      FBarcod := Value;
  end;
end;
